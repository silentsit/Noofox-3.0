            ...
            {[
              {
                ...
                description:
                  "Browse our selection of premium Modafinil and Armodafinil products.",
              },
              {
                step: "02",
                title: "Secure Payment",
                description:
                  "Pay with crypto directly or use card via our secure on-ramp partner.",
              },
              {
                step: "03",
                title: "Fast Delivery",
                description:
                  "Receive your order in discreet packaging with full tracking.",
              },
            ].map((item, index) => (
