...
export const metadata: Metadata = {
  title: "About Us | Noofox",
  description: "Learn about Noofox - your trusted source for premium cognitive enhancers. We provide high-quality Modafinil and Armodafinil with worldwide shipping.",
}
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-6 space-y-4 text-muted-foreground">
                <p>
                  Noofox started as a passion project by a group of
                  professionals who experienced firsthand the benefits of
                  cognitive enhancers. Frustrated with unreliable vendors and
                  inconsistent quality, we decided to create the service we
                  wished existed.
                </p>
                <p>
                  Today, we&apos;ve grown to serve over 50,000 customers worldwide,
                  maintaining the same commitment to quality and service that
                  started us on this journey. We source only from licensed
                  pharmaceutical manufacturers and maintain strict quality
                  control processes.
                </p>
                <p>
                  Our team includes pharmacologists, logistics experts, and
                  customer service professionals united by a shared belief in
                  the potential of cognitive enhancement to help people achieve
                  their goals.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                We ship to over 150 countries with full tracking and discreet
                packaging. Our logistics network ensures fast delivery times
                and high success rates, even to challenging destinations.
              </p>
        ...
        <div className="mt-20 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Browse our selection of premium cognitive enhancers and experience
            the Noofox difference for yourself.
          </p>
