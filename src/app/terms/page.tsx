    ...
    <div className="py-12">
      <div className="mx-auto max-w-3xl px-4 lg:px-8">
        ...
        <div className="mt-12 space-y-8 text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">4. Orders and Payments</h2>
            <p className="mt-4">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">6. Refunds and Returns</h2>
            <p className="mt-4">
